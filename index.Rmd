...
Thank you.
The section numbers in this tutorial link back to the corresponding section of the original text, in case you want to compare them.^[It's important to note that this tutorial is not meant to compare Python and R.
The never-ending flame wars between these two languages are boring and unproductive.] Only this preface and the few footnotes scattered among the text are entirely mine.
